...
namespace google\spanner\admin\instance\v1 {
  ...
  class InstanceAdminClient extends \Grpc\BaseStub {
    ...
    /**
     * @param google\spanner\admin\instance\v1\Instance $input
     */
    public function CreateInstance(\google\spanner\admin\instance\v1\Instance $argument, $metadata = array(), $options = array()) {
     ...
     * @param google\spanner\admin\instance\v1\Instance $input
     */
    public function UpdateInstance(\google\spanner\admin\instance\v1\Instance $argument, $metadata = array(), $options = array()) {
